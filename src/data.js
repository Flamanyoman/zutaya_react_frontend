// this page contains all data that might be passed in as props into components
...
const specialCard = {
  specialCard_pricing: {
    h3: 'Hosting a cheriable or humaniterian event?',
    p: 'We offer special discounts to such events, click on Humaniterian while creating events',
    button: 'Host event',
    link: '/create-event',
  },
};
...
export { homeFeatures, specialCard, banks, states, time };
